...
namespace Semcosm.HardwareConsole.App
{
    public partial class App : Application
    {
        ...
        private static void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<IFanPolicyRuntimeService, MockFanPolicyRuntimeService>();
            services.AddSingleton<IPowerPolicyRuntimeService, MockPowerPolicyRuntimeService>();
            services.AddSingleton<ISchedulerPolicyRuntimeService, MockSchedulerPolicyRuntimeService>();
